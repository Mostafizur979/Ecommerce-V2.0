    ...
    return (
        <div className="bg-white rounded-lg shadow-sm overflow-hidden relative">
            <div className="w-full p-4 border-b-2 border-[#F2F4F8]">
                <div className="w-full h-[180px] md:h-[200px] lg:h-[220px] cursor-pointer relative" onClick={() => { goTo(data?.SKU) }}>
                    <Image
            ...
            <div className="p-4">
                <p className="w-full text-[15px] text-[#111111] truncate hover:text-red-600 cursor-pointer" onClick={() => { goTo(data?.id) }}>{data?.Pname}</p>
