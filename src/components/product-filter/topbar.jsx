...
export default function TopBar({ setIsTwo, setSorting, sorting, setIsHideFilter, isHideFilter, setIsShowMobileFilter }) {
    return (
        <>
            <div className="grid grid-cols-5 border-y border-gray-200 my-4 bg-white px-4 items-center">
                <div
                    className="hidden xl:flex items-center justify-between py-[18px] pr-[18px] text-[15px] text-black border-r border-gray-200"
                ...
                <div
                    className="flex items-center justify-between py-[18px] pr-[18px] text-[14px] xl:hidden text-black border-r border-gray-200"
                    onClick={() => { setIsShowMobileFilter(true) }}
                >
                    <p className="hidden xl:block">{isHideFilter ? 'Show Filters' : 'Hide Filters'}</p>
                    <IoFilter size={24} />
                </div>
